#!/usr/bin/env sh
# Universal installer for honeytrace. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/honeytrace.git"
echo "Installing honeytrace ..."
